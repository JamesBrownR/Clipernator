...
clownNoseImg.src = '/Clipernator/sprites/items/clownish/clownNose.png'; // adjust path to your sprite
const clownWaveImg = new Image();
clownWaveImg.src = '/Clipernator/sprites/items/clownish/clownWave.png'; // adjust path
