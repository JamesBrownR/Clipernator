...
Make enemies more interactive overall:
  ...
  * if possible, there should be a animation of the stage getting bigger after you kill boss one, rather than a instant transition (UPDATE: This works but the note has not been removed since the game still asks you to "Descend" and pauses briefly after you kill the boss. that should be removed so it happens instantly anyway.
