...
- masks should chase you when happy, run away when crying
- double layered cake (and potentially other upgrades) can still be offered when you have its superior, triple layered cake
